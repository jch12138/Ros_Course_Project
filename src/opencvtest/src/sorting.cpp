...
vector<int> hsvorange = {1, 11, 25, 43, 255, 46, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvpurple = {2, 125, 155, 43, 255, 46, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvgreen = {3, 35, 77, 43, 255, 46, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvyellow = {4, 26, 34, 43, 255, 46, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvred = {5, 156, 180, 43, 255, 46, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvblue = {6, 100, 124, 43, 255, 46, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
...
public:
    ...
    void process(cv_bridge::CvImagePtr &cv_ptr, cube &color)
    {
        ...
        for (int i = 0; i < color.getContours().size(); i++)
        {
            ...
            if (rect[i].area() > 6000 && rect[i].area() < 10000)
