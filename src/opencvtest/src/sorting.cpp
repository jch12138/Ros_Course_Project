...
vector<int> hsvorange =     {1,     15,     25,     43,     255, 30, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvpurple =     {2,     130,    160,    43,     255, 30, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvgreen =      {3,     40,     80,      43,    255, 20, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvyellow =     {4,     30,     40,     43,     255, 30, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvred =        {5,     5,      25,     43,     255, 30, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
vector<int> hsvblue =       {6,     90,     130,     43,    255, 30, 255}; //预设颜色的 HSV 三通道范围,其中 0 号元素作颜色序号,用来标识各种颜色,可按照自己需求和颜色表自由添加
...
public:
    ...
    void process(cv_bridge::CvImagePtr &cv_ptr, cube &color)
    {
        ...
        for (int i = 0; i < color.getContours().size(); i++)
        {
            ...
            if (rect[i].area() > 5000 && rect[i].area() < 15000)
