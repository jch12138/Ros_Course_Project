...
"""autogenerated by genpy from ros_test/pixel_point0.msg. Do not edit."""
import sys
...
class pixel_point0(genpy.Message):
  _md5sum = "568de94a5e690be17be9fc43dbdabde8"
  _type = "ros_test/pixel_point0"
...
float64[] orange_u
float64[] orange_v"""
  __slots__ = ['name','red_u','red_v','yellow_u','yellow_v','green_u','green_v','purple_u','purple_v','orange_u','orange_v']
  _slot_types = ['string','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,red_u,red_v,yellow_u,yellow_v,green_u,green_v,purple_u,purple_v,orange_u,orange_v
